...
class WebcomposerConfigPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Form', $namespaces, $module_handler, 'Drupal\webcomposer_config_schema\Plugin\WebcomposerConfigPluginInterface', 'Drupal\webcomposer_config_schema\Annotation\WebcomposerConfigPlugin');
