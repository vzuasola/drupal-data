...
/**
 * Provides a 'webform_custom_submit' element.
 *
 * @WebformElement(
 *   id = "webform_custom_submit",
 *   label = @Translation("Submit(s)"),
 *   description = @Translation("Provides an element that contains a Webform's submit button."),
 *   category = @Translation("submit label"),
 * )
 */
class WebformCustomSubmit extends ContainerBase {
