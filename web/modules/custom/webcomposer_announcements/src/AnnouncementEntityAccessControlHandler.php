 ...
 *
 * @see \Drupal\webcomposer_announcements\Entity\AnnouncementEntity.
 */
class AnnouncementEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\webcomposer_announcements\Entity\AnnouncementEntityInterface $entity */
    switch ($operation) {
      case 'view':
