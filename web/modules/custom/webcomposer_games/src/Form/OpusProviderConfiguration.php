...
class OpusProviderConfiguration extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['opus_game_real_play_url'] = array(
      '#type' => 'textfield',
      '#title' => t('Opus Real Play Game url'),
      '#description' => $this->t('Defines the Opus Real Play Game Url'),
      '#default_value' => $config->get('opus_game_real_play_url')
    );
