...
Drupal.behaviors.blockDrag = {
  attach: function (context, settings) {
    ...
    Drupal.theme.tableDragChangedWarning = function () {
      return '<div class="messages warning">' + Drupal.theme('tableDragChangedMarker') + ' ' + Drupal.t('The changes to these domains will not be saved until the <em>Save Domains</em> button is clicked.') + '</div>';
    };
