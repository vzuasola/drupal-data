...
namespace Drupal\conflict\Field\FieldComparator;

use Drupal\Component\Utility\SortArray;
use Drupal\conflict\FieldComparator\Annotation\FieldComparator;
...
class FieldComparatorManager extends DefaultPluginManager implements FieldComparatorManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      ...
      $namespaces,
      $module_handler,
      'Drupal\conflict\Field\FieldComparator\FieldComparatorPluginInterface',
      'Drupal\conflict\Field\FieldComparator\Annotation\FieldComparator'
    );
  ...
  public function hasChanged(FieldItemListInterface $items_a, FieldItemListInterface $items_b, $langcode, $entity_type_id, $bundle, $field_type, $field_name) {
    ...
    $entity_type_id_g = 'entity_type_' . FieldComparatorPluginInterface::APPLIES_TO_ALL;
    $bundle_g = 'bundle_' . FieldComparatorPluginInterface::APPLIES_TO_ALL;
    $field_type_g = 'field_type_' . FieldComparatorPluginInterface::APPLIES_TO_ALL;
    $field_name_g = 'field_name_' . FieldComparatorPluginInterface::APPLIES_TO_ALL;

    /** @var \Drupal\conflict\Field\FieldComparator\FieldComparatorPluginInterface[] $comparators */
    $comparators = [];
