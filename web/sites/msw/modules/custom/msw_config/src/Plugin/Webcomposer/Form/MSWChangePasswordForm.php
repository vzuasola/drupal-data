...
/**
 * MSWChangePasswordForm.
 *
 * @WebcomposerForm(
 *   id = "msw_change_password_form",
 *   name = "MSW Change Password Form",
 * )
 */

 class MSWChangePasswordForm extends WebcomposerFormBase implements WebcomposerFormInterface {
