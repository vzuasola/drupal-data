 ...
 *   id = "jamboree_my_account",
 *   route = {
 *     "title" = "My Account Page Configuration",
 *     "path" = "/admin/config/jamboree/my_account_configuration",
 *   },
 *   menu = {
 *     "title" = "My Account Page Configuration",
 ...
 * )
 */
class JamboreeMyAccountConfigForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['jamboree_config.my_account_page_configuration'];
  }
