 ...
 *   id = "jamboree_game_provider_integration",
 *   route = {
 *     "title" = "Game Provider Configuration",
 *     "path" = "/admin/config/jamboree/game_provider_configuration",
 *   },
 *   menu = {
 *     "title" = "Game Provider Configuration",
 ...
 * )
 */
class JamboreeGameProviderForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['jamboree_config.game_provider_configuration'];
  }
