 ...
 *   id = "jamboree_special_promotions",
 *   route = {
 *     "title" = "Special Promotions Page Configuration",
 *     "path" = "/admin/config/jamboree/special_promotions_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Special Promotions Page Configuration",
 ...
 * )
 */
class JamboreeSpecialPromotionsConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['jamboree_config.special_promotions_page_configuration'];
  }
