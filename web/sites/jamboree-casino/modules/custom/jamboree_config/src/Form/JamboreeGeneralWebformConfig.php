 ...
 *   id = "jamboree_general_webform",
 *   route = {
 *     "title" = "General Webform Configuration",
 *     "path" = "/admin/config/jamboree/general_webform_configuration",
 *   },
 *   menu = {
 *     "title" = "General Webform Configuration",
 ...
 * )
 */
class JamboreeGeneralWebformConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['jamboree_config.general_webform_configuration'];
  }
