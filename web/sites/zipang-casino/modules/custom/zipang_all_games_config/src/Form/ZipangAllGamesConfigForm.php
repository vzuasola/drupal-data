...
/**
 * Zipang All Games Configurations
 *
 * @WebcomposerConfigPlugin(
 *   id = "zipang_all_games_config",
 *   route = {
 *     "title" = "Zipang All Games Configurations",
 *     "path" = "/admin/config/all-games/settings",
 *   },
 *   menu = {
 *     "title" = "Zipang All Games Configurations",
 *     "description" = "Provides configuration for all games page.",
 *     "parent" = "zipang_all_games_config.admin_settings",
 *     "weight" = 30
 *   },
 * )
 */
class ZipangAllGamesConfigForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['zipang_config.all_games_config'];
  }
