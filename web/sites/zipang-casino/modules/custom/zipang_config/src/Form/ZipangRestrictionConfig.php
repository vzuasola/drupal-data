 ...
 *   id = "zipang_restriction",
 *   route = {
 *     "title" = "Restriction Configuration",
 *     "path" = "/admin/config/zipang/restriction_config",
 *   },
 *   menu = {
 *     "title" = "Restriction Configuration",
 ...
 * )
 */
class ZipangRestrictionConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['zipang_config.restriction_config'];
  }
  ...
  private function sectionAccessRestriction(array &$form) {
    ...
    $form['access_restriction']['official_domain'] = [
      ...
      '#default_value' => $this->get('official_domain') ?? "www.zipangcasino.com",
