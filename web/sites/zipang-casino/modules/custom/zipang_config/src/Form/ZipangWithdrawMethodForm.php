 ...
 *   id = "zipang_withdraw_method_form",
 *   route = {
 *     "title" = "Withdraw Method Page Configuration",
 *     "path" = "/admin/config/zipang/withdraw_method_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Withdraw Method Page Configuration",
 ...
 * )
 */
class ZipangWithdrawMethodForm extends FormBase {

    /**
     * {@inheritdoc}
     */
    protected function getEditableConfigNames() {
        return ['zipang_config.withdraw_method_page_configuration'];
    }
