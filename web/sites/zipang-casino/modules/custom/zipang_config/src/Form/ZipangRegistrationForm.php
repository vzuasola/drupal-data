 ...
 *   id = "zipang_registration",
 *   route = {
 *     "title" = "Registration Configuration",
 *     "path" = "/admin/config/zipang/registration_configuration",
 *   },
 *   menu = {
 *     "title" = "Registration Configuration",
 ...
 * )
 */
class ZipangRegistrationForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['zipang_config.registration_configuration'];
  }
