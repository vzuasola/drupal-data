 ...
 *   id = "zipang_forgot_password",
 *   route = {
 *     "title" = "Zipang Forgot Password Configuration",
 *     "path" = "/admin/config/zipang/forgot_password_configuration",
 *   },
 *   menu = {
 *     "title" = "Zipang Forgot Password Configuration",
 *     "description" = "Provides forgot password configuration",
 *     "parent" = "zipang_config.zipang_config",
 *     "weight" = 30
 *   },
 * )
 */
class ZipangForgotPassword extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['zipang_config.forgot_password_configuration'];
  }
