 ...
 *   id = "zipang_weekly_winner",
 *   route = {
 *     "title" = "Weekly Winner Page Configuration",
 *     "path" = "/admin/config/zipang/weekly_winner_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Weekly Winner Page Configuration",
 ...
 * )
 */
class ZipangWeeklyWinnerForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['zipang_config.weekly_winner_page_configuration'];
  }
