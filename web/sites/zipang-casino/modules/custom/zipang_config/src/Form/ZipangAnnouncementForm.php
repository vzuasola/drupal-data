 ...
 *   id = "zipang_announcement",
 *   route = {
 *     "title" = "Announcement Configuration",
 *     "path" = "/admin/config/zipang/announcement_configuration",
 *   },
 *   menu = {
 *     "title" = "Announcement Configuration",
 ...
 * )
 */
class ZipangAnnouncementForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['zipang_config.announcement_configuration'];
  }
