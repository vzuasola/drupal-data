 ...
 *   id = "ghana_opera_mini_config_form",
 *   route = {
 *     "title" = "Opera Mini Configuration",
 *     "path" = "/admin/config/ghana/opera_mini_configuration",
 *   },
 *   menu = {
 *     "title" = "Opera Mini Configuration",
...
class GhanaOperaMiniConfigForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['ghana_config.opera_mini_configuration'];
  }
