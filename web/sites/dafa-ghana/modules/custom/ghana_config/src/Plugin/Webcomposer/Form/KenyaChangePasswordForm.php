...
/**
 * KenyaChangePasswordForm.
 *
 * @WebcomposerForm(
 *   id = "kenya_change_password_form",
 *   name = "Kenya Change Password Form",
 * )
 */

 class KenyaChangePasswordForm extends WebcomposerFormBase implements WebcomposerFormInterface {
