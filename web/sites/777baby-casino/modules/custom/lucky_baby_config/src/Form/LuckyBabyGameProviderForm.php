 ...
 *   id = "lucky_baby_game_provider_integration",
 *   route = {
 *     "title" = "Game Provider Configuration",
 *     "path" = "/admin/config/lucky_baby/game_provider_configuration",
 *   },
 *   menu = {
 *     "title" = "Game Provider Configuration",
 ...
 * )
 */
class LuckyBabyGameProviderForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.game_provider_configuration'];
  }
