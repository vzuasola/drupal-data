 ...
 *   id = "lucky_baby_download",
 *   route = {
 *     "title" = "Download Configuration",
 *     "path" = "/admin/config/lucky_baby/download_configuration",
 *   },
 *   menu = {
 *     "title" = "Download Configuration",
 ...
 * )
 */
class LuckyBabyDownloadConfigForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.download_configuration'];
  }
