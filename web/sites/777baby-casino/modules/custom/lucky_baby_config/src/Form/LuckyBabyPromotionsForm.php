 ...
 *   id = "lucky_baby_promotions",
 *   route = {
 *     "title" = "Promotions Page Configuration",
 *     "path" = "/admin/config/lucky_baby/promotions_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Promotions Page Configuration",
 ...
 * )
 */
class LuckyBabyPromotionsForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.promotions_page_configuration'];
  }
