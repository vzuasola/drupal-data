 ...
 *   id = "lucky_baby_general_webform",
 *   route = {
 *     "title" = "General Webform Configuration",
 *     "path" = "/admin/config/lucky_baby/general_webform_configuration",
 *   },
 *   menu = {
 *     "title" = "General Webform Configuration",
 ...
 * )
 */
class LuckyBabyGeneralWebformConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.general_webform_configuration'];
  }
