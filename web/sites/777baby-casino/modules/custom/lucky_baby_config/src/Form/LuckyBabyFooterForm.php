 ...
 *   id = "lucky_baby_footer",
 *   route = {
 *     "title" = "Footer Configuration",
 *     "path" = "/admin/config/lucky_baby/footer_configuration",
 *   },
 *   menu = {
 *     "title" = "Footer Configuration",
 ...
 * )
 */
class LuckyBabyFooterForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.footer_configuration'];
  }
