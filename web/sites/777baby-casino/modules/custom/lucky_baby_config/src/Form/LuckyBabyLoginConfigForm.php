 ...
 *   id = "lucky_baby_login_config",
 *   route = {
 *     "title" = "Login Form Configuration",
 *     "path" = "/admin/config/lucky_baby/login_configuration",
 *   },
 *   menu = {
 ...
 * )
 */
class LuckyBabyLoginConfigForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.login_configuration'];
  }
