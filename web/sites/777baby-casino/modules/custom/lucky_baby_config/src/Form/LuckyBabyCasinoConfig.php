 ...
 *   id = "lucky_baby_casino_config",
 *   route = {
 *     "title" = "Lucky Baby Casino Page Configuration",
 *     "path" = "/admin/config/lucky_baby/page_configuration",
 *   },
 *   menu = {
 *     "title" = "Lucky Baby Casino Page Configuration",
 *     "description" = "Provides Lucky Baby Casino page configuration",
 *     "parent" = "lucky_baby_config.lucky_baby_config",
 *     "weight" = 30
 *   },
 * )
 */
class LuckyBabyCasinoConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.page_configuration'];
  }
