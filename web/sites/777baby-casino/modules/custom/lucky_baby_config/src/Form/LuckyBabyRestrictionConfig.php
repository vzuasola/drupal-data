 ...
 *   id = "lucky_baby_restriction",
 *   route = {
 *     "title" = "Restriction Configuration",
 *     "path" = "/admin/config/lucky_baby/restriction_config",
 *   },
 *   menu = {
 *     "title" = "Restriction Configuration",
 ...
 * )
 */
class LuckyBabyRestrictionConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.restriction_config'];
  }
  ...
  private function sectionAccessRestriction(array &$form) {
    ...
    $form['access_restriction']['official_domain'] = [
      ...
      '#default_value' => $this->get('official_domain') ?? "www.777baby.com",
