 ...
 *   id = "lucky_baby_registration",
 *   route = {
 *     "title" = "Registration Configuration",
 *     "path" = "/admin/config/lucky_baby/registration_configuration",
 *   },
 *   menu = {
 *     "title" = "Registration Configuration",
 ...
 * )
 */
class LuckyBabyRegistrationForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.registration_configuration'];
  }
