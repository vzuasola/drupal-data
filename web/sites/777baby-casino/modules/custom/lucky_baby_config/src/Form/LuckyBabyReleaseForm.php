 ...
 *   id = "lucky_baby_release",
 *   route = {
 *     "title" = "Release Page Configuration",
 *     "path" = "/admin/config/lucky_baby/release_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Release Page Configuration",
 ...
 * )
 */
class LuckyBabyReleaseForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.release_page_configuration'];
  }
