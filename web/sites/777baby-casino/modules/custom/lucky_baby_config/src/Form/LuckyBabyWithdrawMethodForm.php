 ...
 *   id = "lucky_baby_withdraw_method_form",
 *   route = {
 *     "title" = "Withdraw Method Page Configuration",
 *     "path" = "/admin/config/lucky_baby/withdraw_method_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Withdraw Method Page Configuration",
 ...
 * )
 */
class LuckyBabyWithdrawMethodForm extends FormBase {

    /**
     * {@inheritdoc}
     */
    protected function getEditableConfigNames() {
        return ['lucky_baby_config.withdraw_method_page_configuration'];
    }
