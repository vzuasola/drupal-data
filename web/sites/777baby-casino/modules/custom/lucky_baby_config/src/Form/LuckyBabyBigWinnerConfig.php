 ...
 *   id = "lucky_baby_big_winner",
 *   route = {
 *     "title" = "Big Winner Page Configuration",
 *     "path" = "/admin/config/lucky_baby/big_winner_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Big Winner Page Configuration",
 ...
 * )
 */
class LuckyBabyBigWinnerConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.big_winner_page_configuration'];
  }
