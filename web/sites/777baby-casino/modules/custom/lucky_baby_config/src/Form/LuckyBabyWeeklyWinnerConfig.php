 ...
 *   id = "lucky_baby_weekly_winner",
 *   route = {
 *     "title" = "Weekly Winner Page Configuration",
 *     "path" = "/admin/config/lucky_baby/weekly_winner_page_configuration",
 *   },
 *   menu = {
 *     "title" = "Weekly Winner Page Configuration",
 ...
 * )
 */
class LuckyBabyWeeklyWinnerConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.weekly_winner_page_configuration'];
  }
