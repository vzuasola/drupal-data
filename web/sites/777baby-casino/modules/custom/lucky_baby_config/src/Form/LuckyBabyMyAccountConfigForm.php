 ...
 *   id = "lucky_baby_my_account",
 *   route = {
 *     "title" = "My Account Page Configuration",
 *     "path" = "/admin/config/lucky_baby/my_account_configuration",
 *   },
 *   menu = {
 *     "title" = "My Account Page Configuration",
 ...
 * )
 */
class LuckyBabyMyAccountConfigForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.my_account_page_configuration'];
  }
