 ...
 *   id = "lucky_baby_fair_gaming",
 *   route = {
 *     "title" = "Fair Gaming Configuration",
 *     "path" = "/admin/config/lucky_baby/fair_gaming_configuration",
 *   },
 *   menu = {
 *     "title" = "Fair Gaming Configuration",
 ...
 * )
 */
class LuckyBabyFairGamingConfig extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.fair_gaming_configuration'];
  }
