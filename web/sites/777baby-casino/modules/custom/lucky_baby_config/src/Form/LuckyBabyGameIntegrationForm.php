 ...
 *   id = "lucky_baby_game_integration",
 *   route = {
 *     "title" = "Game Integration Configuration",
 *     "path" = "/admin/config/lucky_baby/game_integration_configuration",
 *   },
 *   menu = {
 *     "title" = "Game Integration Configuration",
 ...
 * )
 */
class LuckyBabyGameIntegrationForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.game_integration_configuration'];
  }
