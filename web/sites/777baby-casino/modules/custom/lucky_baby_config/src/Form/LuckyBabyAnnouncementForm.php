 ...
 *   id = "lucky_baby_announcement",
 *   route = {
 *     "title" = "Announcement Configuration",
 *     "path" = "/admin/config/lucky_baby/announcement_configuration",
 *   },
 *   menu = {
 *     "title" = "Announcement Configuration",
 ...
 * )
 */
class LuckyBabyAnnouncementForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['lucky_baby_config.announcement_configuration'];
  }
