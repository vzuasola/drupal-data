...
namespace Drupal\lucky_baby_registration\Plugin\Webcomposer\Form;
 ...
 *
 * @WebcomposerForm(
 *   id = "lucky_baby_registration_form",
 *   name = "Lucky Baby Registration Form",
 * )
 */
class RegistrationForm extends WebcomposerFormBase implements WebcomposerFormInterface {
  ...
  public function getFields() {
    return [
      /* 'wrapper_tab_start' => [
        ...
        'settings' => [
          'markup' => [
            ...
            '#default_value' => '<div class ="fieldset-wrapper-steps">',
          ],
        ],
      ],
      'step_1_label' => [
      ...
      'wrapper_tab_end' => [
        'name' => 'Wrapper End Steps',
        'type' => 'markup',
        'settings' => [
          'markup' => [
            '#title' => 'Wrapper End Steps',
            '#type' => 'textarea',
