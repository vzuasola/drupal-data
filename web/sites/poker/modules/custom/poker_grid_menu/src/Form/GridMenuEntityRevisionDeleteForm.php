...
/**
 * Provides a form for deleting a Grid menu entity revision.
 *
 * @ingroup poker_grid_menu
 */
class GridMenuEntityRevisionDeleteForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new GridMenuEntityRevisionDeleteForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $entity_manager->getStorage('grid_menu_entity'),
  ...
  public function getFormId() {
    return 'grid_menu_entity_revision_delete_confirm';
  }
