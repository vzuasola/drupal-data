...
/**
 * Provides a form for deleting a Video entity revision.
 *
 * @ingroup poker_video_support
 */
class VideoEntityRevisionDeleteForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new VideoEntityRevisionDeleteForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $entity_manager->getStorage('poker_video_entity'),
  ...
  public function getFormId() {
    return 'poker_video_entity_revision_delete_confirm';
  }
