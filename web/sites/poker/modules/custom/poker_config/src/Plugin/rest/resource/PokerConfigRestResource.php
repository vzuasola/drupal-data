...
namespace Drupal\poker_config\Plugin\rest\resource;
 ...
 *
 * @RestResource(
 *   id = "poker_config_rest_resource",
 *   label = @Translation("Poker Config Rest Resource"),
 *   uri_paths = {
 *     "canonical" = "/api/configuration/{id}"
 *   }
 * )
 */
class PokerConfigRestResource extends ResourceBase {
  ...
  public function get($id) {
    ...
    $data = [];
    try {
      $config = \Drupal::config("poker_config.$id");
      $data = $config->get();
