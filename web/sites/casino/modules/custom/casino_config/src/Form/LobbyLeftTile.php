...
class LobbyLeftTile extends ConfigFormBase{
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
      ...
      $form['lobby_left_tile_image'] = array(
        '#type' => 'managed_file',
        '#title' => $this->t('Image'),
        '#default_value' => $config->get('lobby_left_tile_image'),
      ...
      $content = $config->get('lobby_left_tile_content');
      $form['lobby_left_tile_content'] = array(
        '#type' => 'text_format',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $keys = array(
      'lobby_left_tile_title',
      'lobby_left_tile_content',
      'lobby_left_tile_image',
    );
    ...
    foreach($keys as $key){
      if($key == "lobby_left_tile_image"){
        ...
        $file_usage->add($file, 'casino_cofnig', 'managed_file', $fid[0]);
