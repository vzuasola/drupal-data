...
namespace Drupal\soda_casino_games\Form;

use Drupal\webcomposer_config_schema\Form\FormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Soda Casino custom config form plugin
 *
 * @WebcomposerConfigPlugin(
 *   id = "casino_config_form",
 *   route = {
 *     "title" = "Soda Casino Custom Configuration",
 *     "path" = "/admin/games/config",
 *   },
 *   menu = {
 *     "title" = "Soda Casino Custom Configuration",
 *     "description" = "Configure custom soda casino games configuration",
 *     "parent" = "soda_casino_games.admin_settings",
 *     "weight" = -5
 *   },
 * )
 */
class SodaCasinoGamesConfigurationForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['soda_casino_games.games_configuration'];
  }
