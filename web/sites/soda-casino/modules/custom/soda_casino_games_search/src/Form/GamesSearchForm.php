...
namespace Drupal\soda_casino_games_search\Form;
...
class GamesSearchForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return ['soda_casino_games.search_configuration'];
  }
  ...
  public function getFormId() {
    return 'soda_casino_games_search.search_configuration_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('soda_casino_games.search_configuration');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($keys as $key) {
      $this->config('soda_casino_games.search_configuration')->set($key, $form_state->getValue($key))->save();
    }
  }
