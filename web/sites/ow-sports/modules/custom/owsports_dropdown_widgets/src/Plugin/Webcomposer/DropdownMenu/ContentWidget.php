...
class ContentWidget extends ConfigFormBase implements DropdownMenuPluginInterface {
  ...
  protected function getEditableConfigNames() {
    return ['webcomposer_dropdown_menu.dropdown_menu.section.contentwidget'];
  }
  ...
  public function getFormId() {
    return 'contentwidget_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('webcomposer_dropdown_menu.dropdown_menu.section.contentwidget');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($keys as $key) {
      $this->config('webcomposer_dropdown_menu.dropdown_menu.section.contentwidget')->set($key, $form_state->getValue($key))->save();
    }
